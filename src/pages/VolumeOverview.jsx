      ...
      <div className="mx-auto max-w-screen-xl px-5 py-8">
        ...
        <div className="rounded-2xl bg-brand-800 p-7 text-white">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3">
            ...
            <span className="text-[12.5px] text-brand-200">학습 진도 {done}/{days.length} DAY</span>
          </div>
        </div>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="text-[11px] font-bold text-slate-400">
                      {p.kind === 'day' ? `PART ${String(p.num).padStart(2, '0')} · DAY ${p.day}` : `PART ${String(p.num).padStart(2, '0')} · 부록`}
                    </div>
